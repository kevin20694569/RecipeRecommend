...
class GenerateRecipePreference : Equatable {
  ...
  //  var complexity : Complexity!
   ...
   // var temperature : Double!
    ...
    init(id: String, user_id: String, ingredients: [Ingredient], cuisine: [Cuisine], complexity : Complexity, timeLimit : Int? = nil, equipments: [Equipment], temperature: Double? = nil,  additional_text: String? = nil, created_time: String? = nil) {
        self.id = id
    ...
    convenience init?(json : DishPreferenceJson) {
        ...
        self.init(id: id, user_id: user_id, ingredients: ingredients ?? [], cuisine: cuisine ?? [], complexity: complexity, equipments: equipments ?? [], additional_text: json.additional_text, created_time: created_time)
    }
